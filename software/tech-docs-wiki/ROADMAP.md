# Tech Documentation Wiki — Development Roadmap
...
- [ ] Pages module — CRUD + basic workflow
- [ ] Spaces module — CRUD + basic workflow
- [ ] Search module — CRUD + basic workflow
...
### Modules
- [ ] Changelog module — full feature set
