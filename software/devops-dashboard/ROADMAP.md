# DevOps Release Dashboard — Development Roadmap
...
- [ ] Pipelines module — CRUD + basic workflow
- [ ] Deployments module — CRUD + basic workflow
- [ ] Environments module — CRUD + basic workflow
...
### Modules
- [ ] Incidents module — full feature set
- [ ] Uptime module — full feature set
