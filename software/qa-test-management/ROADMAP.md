# QA Test Management — Development Roadmap
...
- [ ] Test Cases module — CRUD + basic workflow
- [ ] Test Runs module — CRUD + basic workflow
- [ ] Defects module — CRUD + basic workflow
...
### Modules
- [ ] Coverage module — full feature set
