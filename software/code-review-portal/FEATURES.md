# Code Review Portal — Feature List
...
### 1. Pull Requests Module
- Create, read, update, delete (CRUD) for all pull requests records
- Search and filter by multiple criteria
- Status management with workflow transitions
- Basic reporting for pull requests
- Data validation and error handling
### 2. My Reviews Module
- Create, read, update, delete (CRUD) for all my reviews records
- Search and filter by multiple criteria
- Status management with workflow transitions
- Basic reporting for my reviews
- Data validation and error handling
### 3. Approvals Module
- Create, read, update, delete (CRUD) for all approvals records
- Search and filter by multiple criteria
- Status management with workflow transitions
- Basic reporting for approvals
- Data validation and error handling
### 4. Metrics Module
- Create, read, update, delete (CRUD) for all metrics records
- Search and filter by multiple criteria
- Status management with workflow transitions
- Basic reporting for metrics
- Data validation and error handling
### 5. Settings Module
- Create, read, update, delete (CRUD) for all settings records
- Search and filter by multiple criteria
- Status management with workflow transitions
- Basic reporting for settings
- Data validation and error handling
