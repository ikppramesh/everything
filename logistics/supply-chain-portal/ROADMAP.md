# Supply Chain Portal — Development Roadmap
...
- [ ] Purchase Orders module — CRUD + basic workflow
- [ ] Shipments module — CRUD + basic workflow
...
### Modules
- [ ] Compliance module — full feature set
