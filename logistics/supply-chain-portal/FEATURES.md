# Supply Chain Portal — Feature List
...
- Data validation and error handling
### 3. Shipments Module
- Create, read, update, delete (CRUD) for all shipments records
- Search and filter by multiple criteria
- Status management with workflow transitions
- Basic reporting for shipments
- Data validation and error handling
### 4. Compliance Module
- Create, read, update, delete (CRUD) for all compliance records
- Search and filter by multiple criteria
- Status management with workflow transitions
