# Warehouse Management System — Development Roadmap
...
- [ ] Inbound module — CRUD + basic workflow
- [ ] Inventory module — CRUD + basic workflow
- [ ] Outbound module — CRUD + basic workflow
...
### Modules
- [ ] Cycle Count module — full feature set
