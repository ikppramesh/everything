# Leave Management System — Feature List
...
### 1. My Leaves Module
- Create, read, update, delete (CRUD) for all my leaves records
- Search and filter by multiple criteria
- Status management with workflow transitions
- Basic reporting for my leaves
- Data validation and error handling
### 2. Team Calendar Module
- Create, read, update, delete (CRUD) for all team calendar records
- Search and filter by multiple criteria
- Status management with workflow transitions
- Basic reporting for team calendar
- Data validation and error handling
### 3. Approvals Module
...
- Data validation and error handling
### 4. Policy Module
- Create, read, update, delete (CRUD) for all policy records
- Search and filter by multiple criteria
- Status management with workflow transitions
- Basic reporting for policy
- Data validation and error handling
### 5. Reports Module
