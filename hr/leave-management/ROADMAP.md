# Leave Management System — Development Roadmap
...
- [ ] My Leaves module — CRUD + basic workflow
- [ ] Team Calendar module — CRUD + basic workflow
- [ ] Approvals module — CRUD + basic workflow
...
### Modules
- [ ] Policy module — full feature set
