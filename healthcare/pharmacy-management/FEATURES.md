# Pharmacy Management System — Feature List
...
### 1. Medicines Module
- Create, read, update, delete (CRUD) for all medicines records
- Search and filter by multiple criteria
- Status management with workflow transitions
- Basic reporting for medicines
- Data validation and error handling
### 2. Sales Counter Module
- Create, read, update, delete (CRUD) for all sales counter records
- Search and filter by multiple criteria
- Status management with workflow transitions
- Basic reporting for sales counter
- Data validation and error handling
### 3. Prescriptions Module
- Create, read, update, delete (CRUD) for all prescriptions records
- Search and filter by multiple criteria
- Status management with workflow transitions
- Basic reporting for prescriptions
- Data validation and error handling
### 4. Expiry Tracker Module
- Create, read, update, delete (CRUD) for all expiry tracker records
- Search and filter by multiple criteria
- Status management with workflow transitions
- Basic reporting for expiry tracker
- Data validation and error handling
