...
- [ ] Medicines module — CRUD + basic workflow
- [ ] Sales Counter module — CRUD + basic workflow
- [ ] Prescriptions module — CRUD + basic workflow
...
### Modules
- [ ] Expiry Tracker module — full feature set
