# Lab Reports Portal — Feature List
...
### 1. Samples Module
- Create, read, update, delete (CRUD) for all samples records
- Search and filter by multiple criteria
- Status management with workflow transitions
- Basic reporting for samples
- Data validation and error handling
### 2. Test Catalog Module
- Create, read, update, delete (CRUD) for all test catalog records
- Search and filter by multiple criteria
- Status management with workflow transitions
- Basic reporting for test catalog
- Data validation and error handling
### 3. Reports Module
