...
### 1. OPD Module
- Create, read, update, delete (CRUD) for all opd records
- Search and filter by multiple criteria
- Status management with workflow transitions
- Basic reporting for opd
- Data validation and error handling
### 2. IPD Module
- Create, read, update, delete (CRUD) for all ipd records
- Search and filter by multiple criteria
- Status management with workflow transitions
- Basic reporting for ipd
- Data validation and error handling
### 3. Pharmacy Module
- Create, read, update, delete (CRUD) for all pharmacy records
- Search and filter by multiple criteria
- Status management with workflow transitions
- Basic reporting for pharmacy
- Data validation and error handling
### 4. Lab Module
- Create, read, update, delete (CRUD) for all lab records
- Search and filter by multiple criteria
- Status management with workflow transitions
- Basic reporting for lab
- Data validation and error handling
### 5. Billing Module
