# Online Exam Portal — Feature List
...
### 1. Exams Module
- Create, read, update, delete (CRUD) for all exams records
- Search and filter by multiple criteria
- Status management with workflow transitions
- Basic reporting for exams
- Data validation and error handling
### 2. Question Bank Module
- Create, read, update, delete (CRUD) for all question bank records
- Search and filter by multiple criteria
- Status management with workflow transitions
- Basic reporting for question bank
- Data validation and error handling
### 3. Results Module
- Create, read, update, delete (CRUD) for all results records
- Search and filter by multiple criteria
- Status management with workflow transitions
- Basic reporting for results
- Data validation and error handling
### 4. Certificates Module
- Create, read, update, delete (CRUD) for all certificates records
- Search and filter by multiple criteria
- Status management with workflow transitions
- Basic reporting for certificates
- Data validation and error handling
