# Online Exam Portal — Development Roadmap
...
- [ ] Exams module — CRUD + basic workflow
- [ ] Question Bank module — CRUD + basic workflow
- [ ] Results module — CRUD + basic workflow
...
### Modules
- [ ] Certificates module — full feature set
