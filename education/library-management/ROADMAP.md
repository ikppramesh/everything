# Library Management System — Development Roadmap
...
- [ ] Books module — CRUD + basic workflow
- [ ] Members module — CRUD + basic workflow
- [ ] Borrowings module — CRUD + basic workflow
...
### Modules
- [ ] Returns module — full feature set
