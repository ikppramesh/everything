# Vehicle Rental System — Development Roadmap
...
- [ ] Fleet module — CRUD + basic workflow
- [ ] Bookings module — CRUD + basic workflow
- [ ] Customers module — CRUD + basic workflow
...
- [ ] Finance module — full feature set
