# Auto Repair Workshop — Feature List
...
### 1. Job Cards Module
- Create, read, update, delete (CRUD) for all job cards records
- Search and filter by multiple criteria
- Status management with workflow transitions
- Basic reporting for job cards
- Data validation and error handling
### 2. Parts Module
- Create, read, update, delete (CRUD) for all parts records
- Search and filter by multiple criteria
- Status management with workflow transitions
- Basic reporting for parts
- Data validation and error handling
### 3. Mechanics Module
- Create, read, update, delete (CRUD) for all mechanics records
- Search and filter by multiple criteria
- Status management with workflow transitions
- Basic reporting for mechanics
- Data validation and error handling
### 4. Billing Module
