...
### 1. Suppliers Module
- Create, read, update, delete (CRUD) for all suppliers records
- Search and filter by multiple criteria
- Status management with workflow transitions
- Basic reporting for suppliers
- Data validation and error handling
### 2. Purchase Orders Module
- Create, read, update, delete (CRUD) for all purchase orders records
- Search and filter by multiple criteria
- Status management with workflow transitions
- Basic reporting for purchase orders
- Data validation and error handling
### 3. GRN Module
- Create, read, update, delete (CRUD) for all grn records
- Search and filter by multiple criteria
- Status management with workflow transitions
- Basic reporting for grn
- Data validation and error handling
### 4. Payments Module
