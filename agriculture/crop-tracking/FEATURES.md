# Crop Tracking System — Feature List
...
### 1. Crops Module
- Create, read, update, delete (CRUD) for all crops records
- Search and filter by multiple criteria
- Status management with workflow transitions
- Basic reporting for crops
- Data validation and error handling
### 2. Irrigation Log Module
- Create, read, update, delete (CRUD) for all irrigation log records
- Search and filter by multiple criteria
- Status management with workflow transitions
- Basic reporting for irrigation log
- Data validation and error handling
### 3. Pesticide Schedule Module
- Create, read, update, delete (CRUD) for all pesticide schedule records
- Search and filter by multiple criteria
- Status management with workflow transitions
- Basic reporting for pesticide schedule
- Data validation and error handling
### 4. Alerts Module
- Create, read, update, delete (CRUD) for all alerts records
- Search and filter by multiple criteria
- Status management with workflow transitions
- Basic reporting for alerts
- Data validation and error handling
### 5. Harvest Module
- Create, read, update, delete (CRUD) for all harvest records
- Search and filter by multiple criteria
- Status management with workflow transitions
- Basic reporting for harvest
- Data validation and error handling
