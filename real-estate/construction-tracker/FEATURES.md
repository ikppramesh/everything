# Construction Project Tracker — Feature List
...
### 1. Projects Module
- Create, read, update, delete (CRUD) for all projects records
- Search and filter by multiple criteria
- Status management with workflow transitions
- Basic reporting for projects
- Data validation and error handling
### 2. Milestones Module
- Create, read, update, delete (CRUD) for all milestones records
- Search and filter by multiple criteria
- Status management with workflow transitions
- Basic reporting for milestones
- Data validation and error handling
### 3. BOQ Module
- Create, read, update, delete (CRUD) for all boq records
- Search and filter by multiple criteria
- Status management with workflow transitions
- Basic reporting for boq
- Data validation and error handling
### 4. Contractors Module
- Create, read, update, delete (CRUD) for all contractors records
- Search and filter by multiple criteria
- Status management with workflow transitions
- Basic reporting for contractors
- Data validation and error handling
### 5. Payments Module
- Create, read, update, delete (CRUD) for all payments records
- Search and filter by multiple criteria
- Status management with workflow transitions
- Basic reporting for payments
- Data validation and error handling
