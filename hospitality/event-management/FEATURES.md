# Event Management Platform — Feature List
...
### 1. Events Module
- Create, read, update, delete (CRUD) for all events records
- Search and filter by multiple criteria
- Status management with workflow transitions
- Basic reporting for events
- Data validation and error handling
### 2. Venues Module
- Create, read, update, delete (CRUD) for all venues records
- Search and filter by multiple criteria
- Status management with workflow transitions
...
- Data validation and error handling
### 4. Guests Module
- Create, read, update, delete (CRUD) for all guests records
- Search and filter by multiple criteria
- Status management with workflow transitions
- Basic reporting for guests
- Data validation and error handling
### 5. Budget Module
- Create, read, update, delete (CRUD) for all budget records
- Search and filter by multiple criteria
- Status management with workflow transitions
- Basic reporting for budget
- Data validation and error handling
