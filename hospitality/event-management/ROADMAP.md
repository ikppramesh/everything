# Event Management Platform — Development Roadmap
...
- [ ] Events module — CRUD + basic workflow
- [ ] Venues module — CRUD + basic workflow
...
### Modules
- [ ] Guests module — full feature set
- [ ] Budget module — full feature set
