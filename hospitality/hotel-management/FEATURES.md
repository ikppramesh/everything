# Hotel Management System — Feature List
...
- Create, read, update, delete (CRUD) for all reservations records
- Search and filter by multiple criteria
- Status management with workflow transitions
- Basic reporting for reservations
- Data validation and error handling
### 2. Front Desk Module
- Create, read, update, delete (CRUD) for all front desk records
- Search and filter by multiple criteria
- Status management with workflow transitions
- Basic reporting for front desk
- Data validation and error handling
### 3. Rooms Module
- Create, read, update, delete (CRUD) for all rooms records
- Search and filter by multiple criteria
- Status management with workflow transitions
- Basic reporting for rooms
- Data validation and error handling
### 4. Housekeeping Module
- Create, read, update, delete (CRUD) for all housekeeping records
- Search and filter by multiple criteria
- Status management with workflow transitions
- Basic reporting for housekeeping
- Data validation and error handling
### 5. Billing Module
- Create, read, update, delete (CRUD) for all billing records
- Search and filter by multiple criteria
- Status management with workflow transitions
- Basic reporting for billing
- Data validation and error handling
