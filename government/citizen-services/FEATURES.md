# Citizen Services Portal — Feature List
...
- Create, read, update, delete (CRUD) for all applications records
- Search and filter by multiple criteria
- Status management with workflow transitions
- Basic reporting for applications
- Data validation and error handling
### 2. Services Catalog Module
- Create, read, update, delete (CRUD) for all services catalog records
- Search and filter by multiple criteria
- Status management with workflow transitions
- Basic reporting for services catalog
- Data validation and error handling
### 3. Status Tracker Module
- Create, read, update, delete (CRUD) for all status tracker records
- Search and filter by multiple criteria
- Status management with workflow transitions
- Basic reporting for status tracker
- Data validation and error handling
### 4. Payments Module
