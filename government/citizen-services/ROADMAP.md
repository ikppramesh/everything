# Citizen Services Portal — Development Roadmap
...
- [ ] Applications module — CRUD + basic workflow
- [ ] Services Catalog module — CRUD + basic workflow
- [ ] Status Tracker module — CRUD + basic workflow
